...
<div class="toolbar">
    <div class="container-fluid">
        ...
        <td><input class="btn btn-success" type="submit" form="cash_out_form" name="submit" value="Сохранить" />

        <a href="cash_out.php"><button type="button" class="btn btn-light">Закрыть</button></a>
...
<section class="card_head">
    <div class="container-fluid">
        <form action="" method="POST" class="horizntal-form" id="cash_out_form">
