...
?> 
            <tr>
                ...
                <td><a href="inside_archive_order.php?id=<?php echo $row["id"]; ?>&&payment_type=<?php echo $row["payment_type"]; ?>&&sale_agent=<?php echo $row["sale_agent"]; ?>&&contractor=<?php echo $row["contractor"]; ?>&&date=<?php echo $row["ord_date"]; ?>">Просмотр</a></td>
                <td><a href="action.php?restore_id=<?=$row['id']?>" onclick="return confirm('Восстановить?')" role="button">Восстановить</a></td
            </tr>
<?php       
    };    
?>
