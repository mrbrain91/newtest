...
<div class="page_name">
    <div class="container-fluid">
        ...
        <span class="right_cus">Редактировать заказ</span>
    </div>    
</div>
...
<div class="container-fluid">
    ...
    ?> 
        <tr>
            ...
            <td class="col-sm-1">
                <span><a href="edit_inside_action.php?id=<?php echo $id; ?>&&payment_type=<?php echo $payment_type; ?>&&sale_agent=<?php echo $sale_agent; ?>&&contractor=<?php echo $contractor; ?>&&date=<?php echo $ord_date; ?>&&orid=<?php echo $id; ?>&&pi=<?php echo $row["id"]; ?>&&pn=<?php echo $row["prod_name"]; ?>&&cn=<?php echo $row["count_name"]; ?>&&dn=<?php echo $row["date_name"]; ?>&&prn=<?php echo $row["price_name"]; ?>&&sn=<?php echo $row["sale_name"]; ?>&&tn=<?php echo $row["total_name"]; ?>">Редактировать</a></span>
            </td>
